...
if %_DEBUG%==1 (
    echo %_DEBUG_LABEL% JaCoCo instrumentation report saved to file "%__TARGET_HTML_DIR%\index.html" 1>&2
) else if %_VERBOSE%==1 (
    echo JaCoCo instrumentation report saved to file "!__TARGET_HTML_DIR:%_ROOT_DIR%=!\index.html" 1>&2
)
goto :eof
